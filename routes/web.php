...
Route::get('/dashboard1', [DashboardController::class,'list'])->name('dashboard.list');
Route::get('/dashboard/export/', [DashboardController::class, 'export'])->name('list.export');
Route::get('/dashboard/export/{id}', [DashboardController::class, 'exportSingleVolunteer'])->name('exportSingleVolunteer');
